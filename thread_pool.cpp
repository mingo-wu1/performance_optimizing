...
//        dlog << LINFO << "mytask start";
        std::cout<<"mytask start"<<std::endl;
...
//        dlog << LINFO << "subtask2 end ";
        std::cout<<"subtask2 end "<<std::endl;
    }
...
//    dlog << LINFO << "schedule a few tasks";
    std::cout<<"schedule a few tasks"<<std::endl;
...
//    dlog << LINFO << "result = " << result;   // prints result = 10
    ...
    // Print the results
    for (unsigned long i = 0; i < vect.size(); ++i)
        std::cout<<"vect["<<i<<"]: " << vect[i].get()<<std::endl;
